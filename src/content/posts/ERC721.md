...
<figure className="space-y-2 text-center text-gray-500 text-xs">
  <img src="/images/ERC721/beacon-proxy-pattern.webp" alt="Beacon Proxy Pattern" />
...
<figure className="space-y-2 text-center text-gray-500 text-xs">
  <img src="/images/ERC721/collection-implementation.webp" alt="Collection Implementation" />
...
<figure className="space-y-2 text-center text-gray-500 text-xs">
  <img src="/images/ERC721/collection-factory.webp" alt="Collection Factory" />
